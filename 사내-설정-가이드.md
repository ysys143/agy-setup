...
gcloud auth application-default set-quota-project gpu-experiment-wdl-2026
```
...
export GOOGLE_CLOUD_PROJECT=gpu-experiment-wdl-2026
...
```bash
gcloud config set project gpu-experiment-wdl-2026
```
